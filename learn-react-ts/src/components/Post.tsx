...
export function Post(props: PostProps) {
  ...
  function eventCreateNewComment(event : FormEvent) {
  ...
  const publishedDateRelativeToNow = formatDistanceToNow(props.author.publishedAt, {
    locale: ptBR,
    addSuffix: true,
  });
    ...
    <article className={styles.post}>
      <header>
        ...
        <time
          ...
          dateTime={props.author.publishedAt.toISOString()} // Use props.publishedAt aqui
        >
